					...
					FETCH payCount INTO total1 ,invitotal1, ceeds1, total2, invitotal2, ceeds2,total3, invitotal3, ceeds3,allInfo;
						...
						END IF;
										...
										if  counttotal > 0 or countinvitotal > 0  then 
												...
												INSERT IGNORE INTO jx_majiang_pub.biz_invite_week SET bizid=tbelongid,date=DATE_ADD(NOW(),INTERVAL -1 day),paytotal=counttotal,gametype=6,rebatetotal=countceeds,bindpeople=countinvitotal 
