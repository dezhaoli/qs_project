...
<%--<script type="text/javascript"s
        src="${pageContext.request.contextPath }/resources/js/customer/web/agent_weekStaInfoHistoryDetail_list.js"></script>--%>
...
<script>
    ...
    var dtGridOption = {
        ...
        checkWidth :'37px',
        extraWidth : '37px',
        loadURL : sys.rootPath + '/settle/agentWeekInfoStaHistoryDetail.html',
        columns : dtGridColumns,
        gridContainer : 'dtGridContainer',
        toolbarContainer : 'dtGridToolBarContainer',
        tools : 'refresh',//'refresh|print|export[excel,csv,pdf,txt]'
        exportFileName : stadate + '_代理商结算审核详情',
        pageSize : pageSize,
