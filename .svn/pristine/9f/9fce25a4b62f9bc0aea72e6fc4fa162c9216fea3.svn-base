...
$(function() {
    ...
    queryRegionPlayingCountTotals(stimePlay,etimePlay,null)
...
function customSearch() {
    ...
    //setOption(appName,playName,stimePlay,etimePlay);
    	queryRegionPlayingCountTotals(stimePlay,etimePlay,region)
    grid.refresh(true);
}


function queryRegionPlayingCountTotals(stime,etime,region){
	$.ajax({
		type: "POST",
		url: sys.rootPath+'/regionPlaying/queryRegionCountTotal.html',
		data:{'stime':stime,'etime':etime,'region':region},
		dataType: "json",
		success: function(data){
