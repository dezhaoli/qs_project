...
<script type="text/javascript"
        src="${pageContext.request.contextPath }/resources/js/customer/web/activity/acti_sendGold_list.js"></script>
        ...
        <div class="col-sm-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h4 class="panel-title" style="text-align: center;">总发放金币数量: <span id="sumGold"></span></h4>
                </div>
            </div>
        </div>
        <div class="col-sm-2">
        ...
        <div class="col-xs-12 widget-container-col ui-sortable"
            ...
            <div class="widget-box transparent ui-sortable-handle"
                ...
                <div class="widget-header">
                    <h4 class="widget-title lighter">活动金币发放列表</h4>
