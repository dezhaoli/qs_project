...
public class ConstantUtil {
    ...
    public static class NoPay{
    	 public static final String RUNFAST_MID ="100002,100004,100007,100008,100029,100130,100163,101647,106400,100069,100246,141214";
    	 ...
    	 public static final String JX_MAJIANG_MID ="100405";
    }
    ...
    public static String getNoPayMid(String gameType){
		...
		case GameTypeConstant.JX_MaJiang:
			val = NoPay.JX_MAJIANG_MID;
			break;
		default:
			break;
		}
