    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="#" class="navbar-brand">
                <small>
                    <%-- <img class="nav-user-photo" src="${ctx }/resources/images/qs.png" height="25px"/> --%>牵手数据分析管理系统
                </small>
            </a>
        ...
        <div class="navbar-buttons navbar-header pull-right"
          ...
          <!--       <li class="green">
                ...
                <li class="light-blue" style="float:left; margin:0px 0px;"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle">
                                           <small>欢迎</small> ${userEntity.userName }
                   <%--  <img class="nav-user-photo" src="${ctx}/resources/images/user.jpg" alt=""/> --%>
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                       ...
                       <%--  <li><a href="javascript:void(0)"
                               nav-menu="切换游戏,/user/infoUI.html?id=${userEntity.id }"> <i
                                class="ace-icon fa fa-user"></i> 切换游戏
                        </a></li> --%>
                        <li class="divider"></li>
