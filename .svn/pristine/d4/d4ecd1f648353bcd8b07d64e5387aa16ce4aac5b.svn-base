...
<div class="row" style="margin-top:5px;">
    <div class="col-xs-12">
        <form id="storeForm" name="storeForm"  class="form-horizontal" role="form" method="post" >
			...
			<input hidden="true" type="text" value="${areaid} " id="id"  name="id">
			<input hidden="true" type="text" value="1212221 " id="sitemid"  name="sitemid">
		 ...
		 $.ajax({
	         ...
	         success: function (msg) {
	        	 if (msg.success=="success"){
	        		  layer.msg(msg.successMsg, {icon: 6,time:500});
	        		  window.setInterval(function (){
	        		        var index = parent.layer.getFrameIndex(window.name); //获取窗口索引
	        		        parent.layer.close(index);
	        		  }, 500)
	        	 }else {
	        		 layer.msg(msg.errorMsg, {icon: 5,time:500});
	        	 }
	         }
