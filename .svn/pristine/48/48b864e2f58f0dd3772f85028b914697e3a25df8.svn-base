...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/bill/member_fides_ranking_list.js"></script>
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">付费排行榜统计</h4>
				<!-- <strong style="color:green; margin-left: 150px"> 
						新增用户总数：<span id="countTotals"></span>
				</strong> --> 
