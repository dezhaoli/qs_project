...
public class Memberagents implements Serializable {
    /** 
	 * @Fields serialVersionUID : 
	 */ 
	private static final long serialVersionUID = 7381937438417083986L;
	...
	public String getMktimeStr()
	{
		return mktimeStr;
	}

	public void setMktimeStr(String mktimeStr)
	{
		this.mktimeStr = mktimeStr;
	}
