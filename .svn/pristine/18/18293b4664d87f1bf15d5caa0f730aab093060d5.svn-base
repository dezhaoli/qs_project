...
$(function() {
        $('#tree').jstree({
            "core" : {
                'data' : {
                    "url" : sys.rootPath + "/group/resourceTree.html?roleId=" + $("#groupId").val(),
                    "dataType" : "json"
                },
                "themes" : {
                    "responsive" : true
...
<div class="page-header">
	<h1>
		数据权限设置-<small>[${groupEntity.userGroupName }]</small>
	</h1>
</div>
...
<div class="center">
	<button id="btnAdd" type="button" onclick="commitBusiness('/group/permission.html' , '/group/toGroupListUi.html')" class="btn btn-success btn-sm">
