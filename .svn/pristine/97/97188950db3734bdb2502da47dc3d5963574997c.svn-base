...
public class TaxesInviteDayServiceImpl implements ITaxesInviteDayService
{
	...
	@Override
	public List<MajiangGameRecord> queryGameRecordListByPage(
			Map<String, Object> parameters)
	{
		return majiangGameRecordMapper.selectByDate(parameters);
	}

	@Override
	public Double queryBusinessAmountTotal(Map<String, Object> parameters)
	{
