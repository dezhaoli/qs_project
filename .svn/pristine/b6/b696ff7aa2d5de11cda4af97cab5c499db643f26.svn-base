...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/businessAgent/memberagent_ranking_list.js"></script>
		...
		<div class="col-xs-12 widget-container-col ui-sortable"
			...
			<div class="widget-box transparent ui-sortable-handle"
				...
				<div class="widget-header">
					<h4 class="widget-title lighter">代理商团队充值排行榜</h4>
