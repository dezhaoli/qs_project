...
<script type="text/javascript" src="${ctx }/resources/js/log/user/game_record_list.js"></script>
...
<!-- 搜索框 -->
     <form class="form-horizontal" >
				<div class="form-group" >
	                ...
	                <div class="col-sm-2">
	                    <input class="form-control" name="startDate" id="startDate" type="text" readonly="readonly"
	                               placeholder="开始日期..."/>
	                </div>
	                <label class="control-label col-sm-1 no-padding-right">结束日期</label>
	                <div class="col-sm-2">
	                    <input class="form-control" name="endDate" id="endDate" type="text" readonly="readonly"
	                               placeholder="结束日期..."/>
	                </div>
	                <div class="col-sm-3">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">牌局统计</h4>
