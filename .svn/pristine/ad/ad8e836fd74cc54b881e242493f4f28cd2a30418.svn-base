...
<script type="text/javascript"
        src="${pageContext.request.contextPath }/resources/js/customer/web/boardStatistics_query_list.js"></script>
        ...
        <div class="col-sm-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h4 class="panel-title" style="text-align: center;">累计牌局总数: <span id="playCount">${playCount}</span>次</h4>
                </div>
            </div>
        </div>
        <div class="col-sm-2">
