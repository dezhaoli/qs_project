...
<script type="text/javascript"
        src="${pageContext.request.contextPath }/resources/js/customer/web/member_agent_cardRecord_list.js"></script>
        ...
        <div class="col-xs-12 widget-container-col ui-sortable"
            ...
            <div class="widget-box transparent ui-sortable-handle"
                ...
                <div class="widget-header">
                    <h4 class="widget-title lighter">牌局记录</h4>
...
<%--<div class="page-content">
    <div class="row" style="margin-top:5px;">
        <div class="col-xs-12">
            &lt;%&ndash;<ul id="myTab" class="nav nav-tabs">
                <li class="active" id="li1"><a href="#userInfo" data-toggle="tab">用户资料</a></li>
                <li id="li2"><a href="#cardRecords" data-toggle="tab">牌局记录</a></li>
                <li id="li3"><a href="#goldOrigin" data-toggle="tab">金币来源</a></li>
            </ul>&ndash;%&gt;

            <div id="myTabContent" class="tab-content">

                <div class="tab-pane fade " id="cardRecords">
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <div class="controls controls-row">
