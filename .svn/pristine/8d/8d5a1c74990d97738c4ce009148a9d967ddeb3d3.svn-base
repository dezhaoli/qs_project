...
public class StrBinaryTurn {
   ...
   /* public static void main(String[] args) {
        ...
        String ss = StrBinaryTurn.str2HexStr("QS");
        String content = StrBinaryTurn.str2HexStr("乐玩互娱");
        byte[] contentLenth =  StrBinaryTurn.hexStringToBytes(content);
        int len = contentLenth.length;
        String lenStr = Integer.toHexString(len);

        lenStr = String.format("%4s",lenStr);
        lenStr= lenStr.replaceAll(" ","0");

        System.out.println("len = " + len);
        System.out.println("ss = " + ss);
        System.out.println("lenStr = " + lenStr);
        System.out.println("contentLenth = " + content);

        System.out.println("--------------------------------------- ");
        System.out.println("结果 = " + ss + lenStr + content);
