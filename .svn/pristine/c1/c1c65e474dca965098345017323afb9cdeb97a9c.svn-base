    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="#" class="navbar-brand">
                <small>
                    <%-- <img class="nav-user-photo" src="${ctx }/resources/images/qs.png" height="25px"/> --%>乐玩互娱商务信息管理系统
                </small>
            </a>
    ...
    <div class="footer">
        <div class="footer-inner">
            ...
            <div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">版权所有&copy; 深圳市乐玩互娱网络科技有限公司</span>
