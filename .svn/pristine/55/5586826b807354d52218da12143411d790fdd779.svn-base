...
var dtGridOption = {
	    ...
	    checkWidth :'37px',
	    extraWidth : '37px',
	    loadURL : sys.rootPath + '/gameRule/queryListByPage.html',
	    columns : dtGridColumns,
	    gridContainer : 'dtGridContainer',
	    toolbarContainer : 'dtGridToolBarContainer',
	    tools : 'refresh|export[excel]',
	    exportFileName : '游戏名堂统计',
	    pageSize : pageSize,
...
var setOption=function (){
	...
	$.ajax({
		type: "POST",
		url: sys.rootPath+'/gameRule/gameRuleList.html',
...
function queryUserLoginCountTotals(stime,etime){
	...
	$.ajax({
		type: "POST",
		url: sys.rootPath+'/gameRule/queryGameRuleCountTotals.html',
