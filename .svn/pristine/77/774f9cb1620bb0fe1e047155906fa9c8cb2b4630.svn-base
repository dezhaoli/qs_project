...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/businessAgent/agent_list.js"></script>
...
<div class="center">
				    <button id="btn" type="button" onclick="webside.common.loadPage('/businessCount/toBusinessCountListUi.html')"
