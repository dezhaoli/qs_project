    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="#" class="navbar-brand">
                <small>
                    <%-- <img class="nav-user-photo" src="${ctx }/resources/images/qs.png" height="25px"/> --%>牵手互动信息管理系统
                </small>
            </a>
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <%--<li><a href="javascript:void(0)"
                               nav-menu="修改密码,/user/passwordUI.html?id=${userEntity.id }&accountName=${userEntity.accountName}&userName=${userEntity.userName}">
    ...
    <div class="main-content">
        ...
        <div class="_zyy_table">
                <table style="">
                      ...
                      <tr style="width: 30%"> 
	                      <th>邀请码：</th> 
	                      <th>${memberInvite.invitecode}(跑得快/跑胡子)</th>
	                  </tr>
                      <tr style="width: 30%"> 
	                      <th>创建时间：</th> 
	                      <th>${userEntity.mktime}
<%-- 				 <fmt:formatDate value="${userEntity.mktime}" type="date" pattern="yyyy-MM-dd"/> --%>
	                      </th>
                      </tr>
                </table>
   		</div>
    ...
    <%-- <c:if test="${ userEntity.phone != null }">
        <jsp:include page="../view/index/userData.jsp"/> 
     </c:if> --%>
<!-- /.main-container -->
...
window.onload = function(){ 
    ...
    layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: sys.rootPath + '/userData.html'
});
} 
</script>
</body>
