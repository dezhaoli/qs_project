...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/user/room_playing_list.js"></script>
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">用户参与房间统计列表</h4>
				<strong style="color:green; margin-left: 150px"> 
						用户累计参与房间总数：<span id="countTotals"></span>
				</strong> 
