...
<script type="text/javascript" src="${ctx }/resources/js/log/user/playing_list.js"></script>
     ...
     <form class="form-horizontal" >
				<div class="form-group" >
	                ...
	                <div class="col-sm-2">
		           	...
		           	<label class="control-label col-sm-1 no-padding-right">游戏玩法</label>
	                <div class="col-sm-2">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">在线在玩数据统计列表</h4>
