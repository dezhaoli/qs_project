...
public class MyRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
		...
		if (memberBusiness != null) {
			...
			List<ResourceEntity> resourceList = resourceMapper.findResourcesByUserId(Constants.Business.roleId);
	 ...
	 */
	protected AuthenticationInfo doGetAuthenticationInfo_bak(AuthenticationToken token) throws AuthenticationException {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		MemberBusiness memberBusiness = businessService.findByPhoneOrEmail(username);
		...
		if (memberBusiness != null) {
			...
			authenticationInfo = new SimpleAuthenticationInfo(
					memberBusiness, // 用户对象
					memberBusiness.getPasswd(), // 密码
					ByteSource.Util.bytes(memberBusiness.getSalt()),// salt=username+salt
					getName() // realm name
			);
            /*
             * NOTE Shiro-redis don't support SimpleAuthenticationInfo created by this constructor
