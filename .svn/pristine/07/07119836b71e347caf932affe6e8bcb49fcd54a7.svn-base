...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="well" style="padding: 5px;">
            <h4 class="blue smaller lighter" style="font-size:18px;" >累计授权直属代理商：${totalAgent}</h4>
            <h5>
            ...
            <%--<h5 class="green smaller lighter">直属代理商详情</h5>
            <h5 class="green smaller lighter">直属代理商子级代理查询</h5>--%>
        </div>
    </div>
    <div class="col-sm-5">
    ...
    <div class="col-xs-12 widget-container-col ui-sortable"
        ...
        <div class="widget-box transparent ui-sortable-handle"
            ...
            <div class="widget-header">
                <h4 class="widget-title lighter">代理商查询</h4>
