...
public class MemberpaymentController extends BaseController
{
	...
	public String  toMemberpaymentUi(){
		return "WEB-INF/view/web/businessAgent/memberpayment_list";
	}
	/**
	 * 
	...
	@RequestMapping("queryPayAmountTotal.html")
	@ResponseBody
	public Object queryPayAmountTotal(String startDate,String endDate){
		try
		{
			ValueOperations<String, String> valueOper = redisTemplate.opsForValue();
			UserEntity userEntity = (UserEntity)SecurityUtils.getSubject().getPrincipal();
