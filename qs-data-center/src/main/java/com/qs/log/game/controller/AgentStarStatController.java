...
public class AgentStarStatController extends BaseController
{
	...
	public Map<String ,Object> userGradeList(String gridPager) {
			...
			if(userEntity.getIfBusiness() != null && userEntity.getIfBusiness()){
				//判断是否是公司负责人
				if(leaderTotals > 0){
					parameters.put("businessIdList",businessIdList);
			...
			parameters.put("businessIdListByGroup", businessIdListByGroup);
	...
	public Map<String,Object> userGradeChar(String eDate,String belongid,String grade,String groupId,String businessId) {
		...
		if(StringUtils.isEmpty(eDate)) {
		 ...
		 parma.put("businessIdListByGroup", businessIdListByGroup);
			...
			if(userEntity.getIfBusiness() != null && userEntity.getIfBusiness()){
				//判断是否是公司负责人
				if(leaderTotals > 0){
					parma.put("businessIdList",businessIdList);
	...
	public String userGradSecondeUi(Model model,String id,String StrDate,String grade){
