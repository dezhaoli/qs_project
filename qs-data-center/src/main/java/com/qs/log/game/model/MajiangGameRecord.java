...
public class MajiangGameRecord {
    private Long id;
    ...
    private Integer uuidTotals;
    private Integer midTotals;
    

   

	public Integer getUuidTotals()
	{
		return uuidTotals;
	}

	public void setUuidTotals(Integer uuidTotals)
	{
		this.uuidTotals = uuidTotals;
	}

	public Integer getMidTotals()
	{
		return midTotals;
	}

	public void setMidTotals(Integer midTotals)
	{
		this.midTotals = midTotals;
	}
