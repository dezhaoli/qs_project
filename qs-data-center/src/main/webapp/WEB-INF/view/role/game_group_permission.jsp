...
$(function() {
        $('#tree').jstree({
            "core" : {
                'data' : {
                    "url" : sys.rootPath + "/game/resourceTree.html?Id=" + $("#groupId").val(),
                    "dataType" : "json"
                },
                "themes" : {
                    "responsive" : true
...
<div class="page-header">
	<h1>
		游戏权限设置-<small>[${groupEntity.groupName }]</small>
	</h1>
</div>
	...
	<div class="col-xs-12">
		...
		<input type="hidden" id="groupId" name="groupId" value="${groupEntity.id }">
		   ...
		   <div class="form-group">
		      <label class="control-label col-sm-1 no-padding-right" for="description">游戏</label>
		      <div class="col-sm-10">
		         <div id="tree"></div>
		      </div>
		   </div>
...
<div class="center">
	<button id="btnAdd" type="button" onclick="commitBusiness('/game/permission.html' , '/game/toGameGroupListUi.html')" class="btn btn-success btn-sm">
	  	<i class="fa fa-user-plus"></i>&nbsp;
		保存
	</button>
		<button id="btn" type="button" onclick="webside.common.loadPage('/game/toGameGroupListUi.html?page=${page.pageNum }&rows=${page.pageSize }&sidx=${page.orderByColumn }&sord=${page.orderByType }')" class="btn btn-info btn-sm">
...
<script>
var ids = [];
commitBusiness = function(commitUrl, listUrl) {
	debugger;
