...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/company/business_memberagent_count.js"></script>
				...
				<div class="form-group" >
					<label class="control-label col-sm-1 no-padding-right">分公司</label>
				 	<div class="col-sm-2" id="divGroupId">
	                    <div class="clearfix">
	                     <select class="form-control" id="groupIdBusiness" name="groupIdBusiness" style="width: 100%" >
					 	 </select>
	                    </div>
	                </div>
