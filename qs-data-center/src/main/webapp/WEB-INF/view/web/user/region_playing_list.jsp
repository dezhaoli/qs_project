...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/user/region_playing_list.js"></script>
...
<!-- 搜索框 -->
     <form class="form-horizontal" >
				<div class="form-group" >
		           	<label class="control-label col-sm-1 no-padding-right">区域名称</label>
	                <div class="col-sm-2">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">区域在玩数据统计列表</h4>
				<strong style="color:green; margin-left: 150px"> 
						区域在玩总人数：<span id="countTotals"></span>
				</strong> 
