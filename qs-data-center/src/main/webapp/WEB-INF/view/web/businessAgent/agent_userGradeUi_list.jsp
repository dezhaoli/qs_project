...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/businessAgent/agent_userGradeUi_list.js"></script>
	...
	<div class="controls controls-row">
       ...
       <b>星级代理商考核规则(时间单位:周)：</b><br/> 
                   一级代理商 ：   充值总金额小于700元 ；         &nbsp;&nbsp; <br/>二级代理商：充值总金额大于等于700元 并且小于1400；<br/>
                   三级代理商 ：  充值总金额大于等于1400元 并且小于2100；         &nbsp;&nbsp; <br/>四级代理商：充值总金额大于等于2100元 并且小于2800；<br/> 
                   五级代理商 ：  充值总金额大于等于2800元； 
             </div>
        </div>
    </div>
			...
			<div class="widget-box transparent ui-sortable-handle"
				...
				<div class="widget-header">
					...
					<!-- <strong style="color:green; margin-left: 150px"> 
						代理商团队充值总金额(含二、三级充值总额)：<span id="countTotals"></span>
					</strong>  -->
