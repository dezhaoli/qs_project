...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/businessAgent/memberpayment_details_list.js"></script>
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">代理商-充值统计</h4>
			...
			<div class="widget-body" style="display: block;">
				...
				<div class="center">
				    <button id="btn" type="button" onclick="webside.common.loadPage('/memberagents/toMemberpaymentUi.html')"
