...
<script type="text/javascript" src="${ctx }/resources/js/customer/web/game/game_rule_list.js"></script>
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">游戏名堂数据列表</h4>
				<strong style="color:green; margin-left: 150px"> 
						名堂总数：<span id="countTotals"></span>
				</strong> 
