...
function backSubmits (){
	$("#list_mun").hide();
	$("#logn").show();
}
</script>
</head>
<body class="login-layout" style="background-color: #DBEDF9">
					...
					<div class="login-container">
						...
						<div class="position-relative">
							<div id="login-box"
								...
								<div class="widget-body" style="text-align: center;" id="logn">
									<div class="widget-main"  >
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee blue"></i>用户登录
										</h4>
										...
										<div class="space-6"></div>
			                                   <input type="hidden" id="rememberMe" name="rememberMe" value="true"/>
												<div class="clearfix" style="padding-left: 75px;">
													  <a href="${url }" > 
														<div style="height: 34px;width: 170px;background: url('${ctx }/resources/images/login_wx.png');border: 0px;border-radius: 20px;">
														  
														</div>
													  </a>
													  <br />
													   <a href="javascript:toHome()" > 
														<div style="height: 34px;width: 170px;background: url('${ctx }/resources/images/phon_login.png');border: 0px;border-radius: 20px;">
														  
														</div>
													  </a>
<%-- 													  <a href="${ctx }/wxLoginNotify.html">登入</a> --%>
												</div>
                                ...
                                <!-- 	start	zyy -->
								<div class="widget-body"  id="list_mun" style="display: none;">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
										...
										<form id="loginform" name="loginform"
											action="${ctx }/loginPhone.html"
											method="post">
											<fieldset>
												<label class="block clearfix"> 
												<span class="block input-icon input-icon-right"> 
													<input name="accountName" id="accountName" type="email" class="form-control" placeholder="用户名" /> 
												...
												<input type="hidden" id="rememberMe" name="rememberMe" value="false"/>
                                                    ...
                                                    <button id="btnBack" type="button" onclick="backSubmits();" class=" width-25 btn btn-success btn-sm btn-primary pull-right" style="height: 35px">
													         返回
													    </button>
												</div>
	...
	<div id="backgroundSlider">
		 <img src="${ctx }/resources/images/background/a.jpg" name="1"/>
		<img src="${ctx }/resources/images/background/b.jpg" name="2"/> 
