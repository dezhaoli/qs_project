...
-webkit-appearance: none;
        ...
        src="${ctx }/resources/js/customer/web/club/club_roomInfo_list.js"></script> 
...
function getParam(){
	  ...
	  var url=sys.rootPath + '/agentClub/getClubRoomSumParam.html';
		$.ajax({
		type : "POST",
		url : url,
		data : {"player1":user1,"sDate":sDate,"eDate":eDate},
		dataType : "json",
		success : function(msg) {
			if (msg.success=true){
		    	$("#oprenRoom").text(msg.mgr.room );
...
function showSettleDetail(mid){
	  ...
	  layer.open({
	        ...
	        fixed: false, //不固定
	        maxmin: true,
	        content: sys.rootPath + '/agentClub/clubRoomDetailUi.html?startTime='+sDate+"&endTime="+eDate+"&mid="+mid
	}); 
}
</script>
