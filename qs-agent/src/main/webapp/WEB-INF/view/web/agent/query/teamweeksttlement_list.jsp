    ...
    <div class="row" style="margin-top:5px;">
        <div class="col-xs-12 widget-container-col ui-sortable"
            ...
            <!-- 开心字描述 -->
             ...
             <div class="well">
				            提示：<br>
				           推广奖励咨询请联系专属客服电话:18028783167 微信:18028783167。<br>
					1、直属会员：每周充值消费额在3500元以下，分成比例 40%；达到3500元以上7000元以下，分成比例 45%； 7000元以上，分成比例 50%； 二级团队分成比例 8%，三级团队分成比例 5%。<br>
					2、您在成为代理商的前三个月，均不代扣个人所得税。超过三个月后，且每周总推广费用在1000元以上者，按4%代扣个人所得税，1000元以下者免扣。（例：三个月后代理商A一周的推广费用达到2000元，代扣税40元，可获得1960元。）<br>
			...
			<!-- 江西文字描述 -->
             ...
             <div class="well">
			            提示：<br>
			            1、直属会员：每周总充值【不包含代理商本人充值金额】消费额在3500元以下者，按40%结算。在3500元至7000元之间者，按45%结算。达到7000元以上者，按50%结算；可获取二级团队总充值消费额的15%。 <br>
             ...
             <c:if test="${gameType <20 and gameType !=17}">
              <div class="well">
				            ...
				            5、本游戏增设代理月奖，以月为一时间单位，当代理直属玩家总充值消费额达到15000-29999元时可获得统计额的5%做为佣金奖励，达到30000元及以上时可获得统计额的10%做为佣金奖励。<br>
