...
<div id="navbar" class="navbar navbar-default">
    ...
    <div class="navbar-container" id="navbar-container"  >
       ...
       <button type="button" class="navbar-toggle menu-toggler pull-left" 
          ...
          <span class="icon-bar"></span> 
          <span class="icon-bar"></span> -->
          <a href="javascript:webside.index.initHomePage();" style="font-size: 30px"><i class="ace-icon fa fa-home home-icon"></i></a>
        </button> 
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="#" class="navbar-brand">
                <small>
                    <%-- <img class="nav-user-photo" src="${ctx }/resources/images/qs.png" height="25px"/> --%>乐玩代理商管理系统
                </small>
            </a>
            ...
            <ul class="nav ace-nav">
               <!--  <li class="green">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          ...
                                          <small>欢迎</small> <%-- ${userEntity.realname } --%>
                    <%-- <img class="nav-user-photo" src="${ctx}/resources/images/user.jpg" alt=""/>
                    <span class="user-info"> <small>欢迎</small> ${userEntity.realname }
						</span>  --%><i class="ace-icon fa fa-caret-down"></i>
                </a>
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                     <!--  <li><a href="javascript:void(0)"
                               nav-menu="代理商后台,修改密码,/user/updatePwd.html">
                            <i class="ace-icon fa fa-cog"></i> 修改密码
                        </a></li>  -->
                       <li><a href="javascript:void(0)"
                               nav-menu="代理商后台,绑定手机,/bindPhone.html">
                            <i class="ace-icon fa fa-odnoklassniki"></i> 绑定手机
                        </a></li> 
                        <li><a href="javascript:void(0)"
                               nav-menu="代理商后台,查看个人资料,/agentroom/showUserInfo.html"> <i
...
>>>>>>> 3c893817d77920bf125f754c99aa2fad59a6a979
                        ...
                        <li> 
                        <a href="${ctx}/gameList.html"> <i class="fa fa-arrows-h" style="font-size: 14px;"></i>
                      	  &nbsp;&nbsp;切换游戏 </a>
                      	</li>
                        <li class="divider">  </li>
                        <li>
                        <a href="${ctx}/logout.html"> <i class="ace-icon fa fa-power-off"></i>
                      	  退出 </a>
                      	</li>
                    </ul>
                </li>
...
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" style="padding-top: 80px;">
    <script type="text/javascript">
        try {
...
<!--         <div class="sidebar-shortcuts" id="sidebar-shortcuts">
        ...
        <ul class="nav nav-list">
            ...
            <c:forEach var="resource" items="${list}" varStatus="s">
                <!-- 一级 -->
                <li level="level1" class="open">
                    <a href="javascript:void(0)" <c:if
                            test="${fn:length(resource.sourceUrl) gt 0 }"> nav-menu="${resource.name },${resource.sourceUrl }"</c:if>
                                ...
                                <li level="level2" class="">
                                    <a href="javascript:void(0)"
                                       ...
                                       class="dropdown-toggle"</c:if>>
                                        ...
                                        <c:if test="${fn:length(firstChildrens.children) gt 0 }"><b
                                    ...
                                    <c:if test="${fn:length(firstChildrens.children) gt 0 }">
                                        <ul class="submenu">
                                            <!-- 三级 -->
                                            <c:forEach var="secondChildrens" items="${firstChildrens.children}"
                                                       varStatus="idx2">
                                                <li level="level3" class="">
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       class="dropdown-toggle"</c:if>>
                                                        ...
                                                        <c:if test="${fn:length(secondChildrens.children) gt 0 }"><b
                                                                class="arrow  fa fa-angle-down"></b></c:if>
                                                    </a>
                                                    <b class="arrow"></b>
                                                    <c:if test="${fn:length(secondChildrens.children) gt 0 }">
                                                        <ul class="submenu">
                                                            ...
                                                            <c:forEach var="thridChildrens"
                                                                       items="${secondChildrens.children}"
                                                                       varStatus="idx3">
                                                                <li level="level4" class="">
                                                                    <a href="javascript:void(0)"
                                                                       <c:if test="${fn:length(thridChildrens.sourceUrl) gt 0 }">nav-menu="${resource.name },${firstChildrens.name },${secondChildrens.name },${thridChildrens.name },${thridChildrens.sourceUrl }"</c:if>
                                                                        <c:if test="${fn:length(thridChildrens.children) gt 0 }">
                                                                       class="dropdown-toggle"</c:if>>
...
/*  window.onload = function(){ 
	...
	if (!phone){
	    layer.open({
	        ...
	        fixed: false, //不固定
	        maxmin: true,
	        content: sys.rootPath + '/user/updateUserInfoUI.html?level=0&areaid='+'${userEntity.areaid}&id='+'${userEntity.id}'
	});
	}
}   */
</script>
