...
public interface ITaxesInviteService {
     ...
     * @return
     */
    Map<String, Object> getPayAndInviteTotalByAgentParentId(Integer agentParentId,String dbName);
     ...
     * @return
     */
    Double getAgentUnderBusinessChangeCountByDate(Map<String, Object> parameters,String dbName);
     ...
     * @time:2017年4月10日
     */
    Map<String, Object> getBusinessCountPayAndTotal(Object id,String dbName);
}
