...
public class ShareLinkController extends BaseController {
    ...
    public String joinRoomViewUi(Model model, ShareLinkRequest shareLinkRequest,
        ...
        //String s = redirectUrl.substring(0, redirectUrl.length() - 1);
        //s = s.substring(0,  s.lastIndexOf("/"));
        //s += "/gdrobot/get-weixin-code.html?";
        //String robotUrl = baseParamService.getBaseParamValueByCode(AppConstants.BaseParam.ROBOT_APP_URL);
        //robotUrl += "/api/shareLink/joinRoom.html";
        //robotUrl = robotUrl.replaceAll(":","%3A");
        //robotUrl = robotUrl.replaceAll("/","%2F");
        ...
        //StringBuilder sb = new StringBuilder(s).append("appid=").append(appId).append("&scope=snsapi_userinfo&state=")
        //        .append(state).append("&redirect_uri=").append(robotUrl);
