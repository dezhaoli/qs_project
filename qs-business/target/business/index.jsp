    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="#" class="navbar-brand">
                <small>
                    <%-- <img class="nav-user-photo" src="${ctx }/resources/images/qs.png" height="25px"/> --%>乐玩互娱商务管理系统
                </small>
            </a>
        ...
        <div class="navbar-buttons navbar-header pull-right"
            ...
            <!--     <li class="green">
                    ...
                    <li class="light-blue"><a data-toggle="dropdown" href="#"
                        ...
                        <%-- <small style="font-size: small;">欢迎${userEntity.name }</small> --%>
                       <%-- <img class="nav-user-photo" src="${ctx}/resources/images/user.jpg" alt=""/> --%>
                         <span class="user-info"> <small>欢迎</small> ${userEntity.name }
...
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" style="padding-top: 48px;">
    <script type="text/javascript">
        try {
