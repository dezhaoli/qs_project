...
<script type="text/javascript"
        src="${pageContext.request.contextPath }/resources/js/customer/web/business_gameChanSear_list.js"></script>
            ...
            <div class="widget-box transparent ui-sortable-handle"
                ...
                <div class="widget-header"><!-- //跑得快 / 跑胡子  -->
                    <c:if test="${!empty gameName}">
                        <h4 class="widget-title lighter">${gameName} 游戏充值查询</h4>
                    </c:if>
                    <c:if test="${empty gameName}">
                        <h4 class="widget-title lighter">游戏充值查询</h4>
                    </c:if>
