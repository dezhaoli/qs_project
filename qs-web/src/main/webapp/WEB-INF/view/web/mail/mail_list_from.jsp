...
<div class="row" style="margin-top:5px;">
    <div class="col-xs-12">
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="#listMail" data-toggle="tab" id="mailListTap">邮件列表</a></li>

            <li><a href="#addMail" data-toggle="tab" id="addMailTap">添加邮件</a></li>
        </ul>
                                ...
                                <div class="col-sm-5">
                                    <div class="clearfix">
                                        <input class="form-control" name="mailTitle" type="text" id="mailTitle"
                                               placeholder="长度不能超过30个字..." maxlength="30"/>
                                    </div>
                                </div>
                            </div>
        ...
        $('#saveMail').on('click',function () {
            ...
            function handleSaveMailData(debug) {
                ...
                if (debug) {
                    ...
                    mailContent = ReplaceSeperator(mailContent);
                    if (attach == null || attach == "") {
