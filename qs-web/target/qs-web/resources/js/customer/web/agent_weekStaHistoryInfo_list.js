...
function showDetail(date,stadate) {
    layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: sys.rootPath + '/' + gameType +'/agentWeekInfoStaHistoryDetailUi.html?date='+
...
function exportExcel(date,stadate) {
    layer.confirm('确认要导出Excel吗？', {
        ...
        $('#iframeOut').attr("src",sys.rootPath + '/' + gameType + "/exportDetailExcel.html?date="
...
var dtGridOption = {
    ...
    checkWidth :'37px',
    extraWidth : '37px',
    loadURL : sys.rootPath + '/'+gameType+'/agentWeekInfoStaHistory.html',
