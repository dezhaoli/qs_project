...
<div class="row" style="margin-top:5px;">
    <div class="col-xs-12">
        <ul id="myTab" class="nav nav-tabs">
            <li class="active" id="listMailLi"><a href="#listMail" data-toggle="tab">返利比例管理</a></li>

            <li id="addMailLi"><a href="#addMail" data-toggle="tab">添加返利比例</a></li>
...
/* function showLi(type){
	...
	case 0:
		$("#updateLi").hide(); 
		$("#listMailLi").addClass("active");
		break;
	case 1:
		$("#updateLi").hide(); 
		$("#addMailLi").addClass("active");
		break;
